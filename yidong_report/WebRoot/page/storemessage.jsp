     ...
     $(function(){ 
    	 $.ajax( {
				...
				success : function(data) {
					...
					//}
					//addMarker(data); 
					var xml = "<chart caption='设备状况' xAxisName='国家' yAxisName='规模' showValues='0' decimals='0' formatNumberScale='0' useRoundEdges='1'>";
					for(var i=0;i<data.length;i++){ 
						if(data[i][0]==0)
							{
							     data[i][0]="暂无设备";
		...
		<table id="listTable" class="easyui-datagrid">  
		    <thead>  
		        <tr>     
		            ...
		            <th data-options="field:'code',width:80">门店编号</th>     
		            <th data-options="field:'storename',width:100">门店名称</th>   
		            <th data-options="field:'clientele',width:100">品牌</th> 
		            <th data-options="field:'downsucesslist',width:100,formatter: function(value,row,index){
							if(value==null || value==''){
								return '未更新';
							}else{
							    return value;
					...
					<th data-options="field:'newestlist',width:100,formatter: function(value,row,index){
							 if(value==null || value==''){
								return '未下发';
							}else{
							    return value;
					...
					<th data-options="field:'newestlistflag',width:100,formatter: function(value,row,index){
							if(value==null){
								return '未下发';
							}else if(value=='S'){
							    return '已更新';
