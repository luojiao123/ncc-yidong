     ...
     $(function(){
			 ...
			 $.ajax( {
				...
				success : function(data) { 
					var dat=data.rows;
					var xml = "<chart caption='门店设备比例' xAxisName='门店' yAxisName='比例' showValues='0' decimals='0' formatNumberScale='0' useRoundEdges='1'>";
					for(var i=0;i<dat.length;i++){ 
					    xml+="<set label ='"+dat[i].id+"' value='"+dat[i].brand+"' /> ";
					}
					xml+="</chart>";
