		...
		if (type == Type.jdk) {
			try {
				...
				/*if (srcHeight >= srcWidth) {
					width = (int) Mathssss.round(((destHeight * 1.0 / srcHeight) * srcWidth));
				} else {
...
//	}*/
	 ...
	 * @return 图片文件路径    
	 */
	public static String copyImageFile(ServletContext servletContext,String path, File imageFile) {
		if (imageFile == null) {
			return null;
		}
		...
		String destImagePath = path+ "/" + CommonUtil.getUUID() + "." + formatName;
